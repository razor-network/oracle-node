...
func (_StakeManager *StakeManagerCaller) GetRoleMember(opts *bind.CallOpts, role [32]byte, index *big.Int) (common.Address, error) {
	var out []interface{}
	err := _StakeManager.contract.Call(opts, &out, "getRoleMember", role, index)
...
//
// Solidity: function getRoleMember(bytes32 role, uint256 index) view returns(address)
func (_StakeManager *StakeManagerSession) GetRoleMember(role [32]byte, index *big.Int) (common.Address, error) {
	return _StakeManager.Contract.GetRoleMember(&_StakeManager.CallOpts, role, index)
}

// GetRoleMember is a free data retrieval call binding the contract method 0x9010d07c.
//
// Solidity: function getRoleMember(bytes32 role, uint256 index) view returns(address)
func (_StakeManager *StakeManagerCallerSession) GetRoleMember(role [32]byte, index *big.Int) (common.Address, error) {
	return _StakeManager.Contract.GetRoleMember(&_StakeManager.CallOpts, role, index)
}
...
func (_StakeManager *StakeManagerCaller) GetRoleMemberCount(opts *bind.CallOpts, role [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _StakeManager.contract.Call(opts, &out, "getRoleMemberCount", role)
...
//
// Solidity: function getRoleMemberCount(bytes32 role) view returns(uint256)
func (_StakeManager *StakeManagerSession) GetRoleMemberCount(role [32]byte) (*big.Int, error) {
	return _StakeManager.Contract.GetRoleMemberCount(&_StakeManager.CallOpts, role)
}

// GetRoleMemberCount is a free data retrieval call binding the contract method 0xca15c873.
//
// Solidity: function getRoleMemberCount(bytes32 role) view returns(uint256)
func (_StakeManager *StakeManagerCallerSession) GetRoleMemberCount(role [32]byte) (*big.Int, error) {
	return _StakeManager.Contract.GetRoleMemberCount(&_StakeManager.CallOpts, role)
}
