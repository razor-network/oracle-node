...
func (_BlockManager *BlockManagerCaller) GetRoleMember(opts *bind.CallOpts, role [32]byte, index *big.Int) (common.Address, error) {
	var out []interface{}
	err := _BlockManager.contract.Call(opts, &out, "getRoleMember", role, index)
...
//
// Solidity: function getRoleMember(bytes32 role, uint256 index) view returns(address)
func (_BlockManager *BlockManagerSession) GetRoleMember(role [32]byte, index *big.Int) (common.Address, error) {
	return _BlockManager.Contract.GetRoleMember(&_BlockManager.CallOpts, role, index)
}

// GetRoleMember is a free data retrieval call binding the contract method 0x9010d07c.
//
// Solidity: function getRoleMember(bytes32 role, uint256 index) view returns(address)
func (_BlockManager *BlockManagerCallerSession) GetRoleMember(role [32]byte, index *big.Int) (common.Address, error) {
	return _BlockManager.Contract.GetRoleMember(&_BlockManager.CallOpts, role, index)
}
...
func (_BlockManager *BlockManagerCaller) GetRoleMemberCount(opts *bind.CallOpts, role [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _BlockManager.contract.Call(opts, &out, "getRoleMemberCount", role)
...
//
// Solidity: function getRoleMemberCount(bytes32 role) view returns(uint256)
func (_BlockManager *BlockManagerSession) GetRoleMemberCount(role [32]byte) (*big.Int, error) {
	return _BlockManager.Contract.GetRoleMemberCount(&_BlockManager.CallOpts, role)
}

// GetRoleMemberCount is a free data retrieval call binding the contract method 0xca15c873.
//
// Solidity: function getRoleMemberCount(bytes32 role) view returns(uint256)
func (_BlockManager *BlockManagerCallerSession) GetRoleMemberCount(role [32]byte) (*big.Int, error) {
	return _BlockManager.Contract.GetRoleMemberCount(&_BlockManager.CallOpts, role)
}
...
// BlockManagerDebugUint256Iterator is returned from FilterDebugUint256 and is used to iterate over the raw logs and unpacked data for DebugUint256 events raised by the BlockManager contract.
type BlockManagerDebugUint256Iterator struct {
	Event *BlockManagerDebugUint256 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BlockManagerDebugUint256Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockManagerDebugUint256)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BlockManagerDebugUint256Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockManagerDebugUint256Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockManagerDebugUint256 represents a DebugUint256 event raised by the BlockManager contract.
type BlockManagerDebugUint256 struct {
	A   *big.Int
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_BlockManager *BlockManagerFilterer) FilterDebugUint256(opts *bind.FilterOpts) (*BlockManagerDebugUint256Iterator, error) {

	logs, sub, err := _BlockManager.contract.FilterLogs(opts, "DebugUint256")
	if err != nil {
		return nil, err
	}
	return &BlockManagerDebugUint256Iterator{contract: _BlockManager.contract, event: "DebugUint256", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DebugUint256(uint256 a)
func (_BlockManager *BlockManagerFilterer) WatchDebugUint256(opts *bind.WatchOpts, sink chan<- *BlockManagerDebugUint256) (event.Subscription, error) {

	logs, sub, err := _BlockManager.contract.WatchLogs(opts, "DebugUint256")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BlockManagerDebugUint256)
				if err := _BlockManager.contract.UnpackLog(event, "DebugUint256", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DebugUint256(uint256 a)
func (_BlockManager *BlockManagerFilterer) ParseDebugUint256(log types.Log) (*BlockManagerDebugUint256, error) {
	event := new(BlockManagerDebugUint256)
	if err := _BlockManager.contract.UnpackLog(event, "DebugUint256", log); err != nil {
		return nil, err
	}
