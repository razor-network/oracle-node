...
func TestSign(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := Sign(hash, account, defaultPath, utilsStruct)
...
func TestGetPrivateKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			getPrivateKeyFromKeystoreMock = func(string, string, UtilsStruct) *ecdsa.PrivateKey {
				return tt.args.privateKey
			}

			got := GetPrivateKey(tt.args.address, password, keystorePath, utilsStruct)
			if !reflect.DeepEqual(got, tt.want) {
