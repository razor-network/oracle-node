...
type mockConstructorTestingTNewAssetManagerInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAssetManagerInterface(t mockConstructorTestingTNewAssetManagerInterface) *AssetManagerInterface {
