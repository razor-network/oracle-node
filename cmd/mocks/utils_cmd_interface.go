...
func (_m *UtilsCmdInterface) CalculateSecret(account types.Account, epoch uint32) ([]byte, []byte, error) {
	...
	var r1 []byte
	if rf, ok := ret.Get(1).(func(types.Account, uint32) []byte); ok {
		r1 = rf(account, epoch)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]byte)
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(types.Account, uint32) error); ok {
		r2 = rf(account, epoch)
	} else {
		r2 = ret.Error(2)
	}
...
// Reveal provides a mock function with given fields: client, config, account, epoch, commitData, secret, signature
func (_m *UtilsCmdInterface) Reveal(client *ethclient.Client, config types.Configurations, account types.Account, epoch uint32, commitData types.CommitData, secret []byte, signature []byte) (common.Hash, error) {
	ret := _m.Called(client, config, account, epoch, commitData, secret, signature)

	var r0 common.Hash
	if rf, ok := ret.Get(0).(func(*ethclient.Client, types.Configurations, types.Account, uint32, types.CommitData, []byte, []byte) common.Hash); ok {
		r0 = rf(client, config, account, epoch, commitData, secret, signature)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(common.Hash)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*ethclient.Client, types.Configurations, types.Account, uint32, types.CommitData, []byte, []byte) error); ok {
		r1 = rf(client, config, account, epoch, commitData, secret, signature)
	} else {
		r1 = ret.Error(1)
	}
...
func NewUtilsCmdInterface(t mockConstructorTestingTNewUtilsCmdInterface) *UtilsCmdInterface {
