...
func (_m *StakeManagerInterfaceMockery) BalanceOf(_a0 *bindings.StakedToken, _a1 *bind.CallOpts, _a2 common.Address) (*big.Int, error) {
...
func (_m *StakeManagerInterfaceMockery) Delegate(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32, _a3 *big.Int) (*types.Transaction, error) {
...
func (_m *StakeManagerInterfaceMockery) ExtendLock(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) GetBountyLock(_a0 *ethclient.Client, _a1 *bind.CallOpts, _a2 uint32) (coretypes.BountyLock, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) GetMaturity(_a0 *ethclient.Client, _a1 *bind.CallOpts, _a2 uint32) (uint16, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) GetTotalSupply(_a0 *bindings.StakedToken, _a1 *bind.CallOpts) (*big.Int, error) {
...
func (_m *StakeManagerInterfaceMockery) RedeemBounty(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) SetDelegationAcceptance(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 bool) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) Stake(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32, _a3 *big.Int) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_m *StakeManagerInterfaceMockery) StakerInfo(_a0 *ethclient.Client, _a1 *bind.CallOpts, _a2 uint32) (coretypes.Staker, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *StakeManagerInterfaceMockery) Unstake(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32, _a3 *big.Int) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)
...
func (_m *StakeManagerInterfaceMockery) UpdateCommission(client *ethclient.Client, opts *bind.TransactOpts, commission uint8) (*types.Transaction, error) {
...
func (_m *StakeManagerInterfaceMockery) Withdraw(_a0 *ethclient.Client, _a1 *bind.TransactOpts, _a2 uint32) (*types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2)
