...
func (_m *UtilsInterface) ReadFromDisputeJsonFile(_a0 string) (types.DisputeFileData, error) {
	ret := _m.Called(_a0)
...
func (_m *UtilsInterface) SaveDataToDisputeJsonFile(_a0 string, _a1 []uint32) error {
	ret := _m.Called(_a0, _a1)
