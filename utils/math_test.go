...
func Test_increasePercentageValue(t *testing.T) {
	type args struct {
		gasLimit           uint64
		percentageIncrease int32
	}
	tests := []struct {
		name string
		args args
		...
		{
			name: "Test 1: When the percentage increase is 50%",
			args: args{
				gasLimit:           250000,
		...
		{
			name: "Test 2: When the percentage increase is 100%",
			args: args{
				gasLimit:           240786,
		...
		{
			name: "Test 3: When the percentage increase is 35%",
			args: args{
				gasLimit:           240786,
		...
		{
			name: "Test 4: When the gas limit is 0",
			args: args{
				gasLimit:           0,
				percentageIncrease: 50,
			},
		...
		{
			name: "Test 5: When the percentage increase is -1%",
			args: args{
				gasLimit:           290786,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := increasePercentageValue(tt.args.gasLimit, tt.args.percentageIncrease); got != tt.want {
				t.Errorf("increasePercentageValue() = %v, want %v", got, tt.want)
			}
		})
	}
}
