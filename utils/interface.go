...
type OptionUtils interface {
	...
	WithdrawInitiationPeriod(*ethclient.Client, *bind.CallOpts) (uint8, error)
	...
	GetJob(*ethclient.Client, *bind.CallOpts, uint16) (bindings.StructsJob, error)
...
type Utils interface {
	...
	GetNumActiveCollections(*ethclient.Client) (*big.Int, error)
