...
func (*UtilsStruct) GetStakerId(rpcParameters types.RPCParameters, address string) (uint32, error) {
...
func (*UtilsStruct) GetStake(rpcParameters types.RPCParameters, stakerId uint32) (*big.Int, error) {
...
func (*UtilsStruct) GetStaker(rpcParameters types.RPCParameters, stakerId uint32) (bindings.StructsStaker, error) {
	returnedValues, err := InvokeFunctionWithRetryAttempts(rpcParameters, StakeManagerInterface, "GetStaker", stakerId)
	if err != nil {
...
func (*UtilsStruct) GetNumberOfStakers(rpcParameters types.RPCParameters) (uint32, error) {
...
func (*UtilsStruct) GetLock(rpcParameters types.RPCParameters, address string, stakerId uint32, lockType uint8) (types.Locks, error) {
...
func (*UtilsStruct) GetWithdrawInitiationPeriod(rpcParameters types.RPCParameters) (uint16, error) {
...
func (*UtilsStruct) GetMaxCommission(rpcParameters types.RPCParameters) (uint8, error) {
...
func (*UtilsStruct) GetEpochLimitForUpdateCommission(rpcParameters types.RPCParameters) (uint16, error) {
...
func (*UtilsStruct) GetMinSafeRazor(rpcParameters types.RPCParameters) (*big.Int, error) {
...
func (*UtilsStruct) StakerInfo(rpcParameters types.RPCParameters, stakerId uint32) (types.Staker, error) {
...
func (*UtilsStruct) GetMaturity(rpcParameters types.RPCParameters, age uint32) (uint16, error) {
...
func (*UtilsStruct) GetBountyLock(rpcParameters types.RPCParameters, bountyId uint32) (types.BountyLock, error) {
