...
func (_m *GasUtils) GetGasLimit(transactionData types.TransactionOptions, txnOpts *bind.TransactOpts) (uint64, error) {
...
func (_m *GasUtils) IncreaseGasLimitValue(client *ethclient.Client, gasLimit uint64, gasLimitMultiplier float32) (uint64, error) {
...
type mockConstructorTestingTNewGasUtils interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGasUtils(t mockConstructorTestingTNewGasUtils) *GasUtils {
	mock := &GasUtils{}
	mock.Mock.Test(t)
