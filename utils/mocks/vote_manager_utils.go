...
// GetCommitment provides a mock function with given fields: client, stakerId
func (_m *VoteManagerUtils) GetCommitment(client *ethclient.Client, stakerId uint32) (types.Commitment, error) {
	ret := _m.Called(client, stakerId)

	var r0 types.Commitment
	var r1 error
	if rf, ok := ret.Get(0).(func(*ethclient.Client, uint32) (types.Commitment, error)); ok {
...
func (_m *VoteManagerUtils) GetInfluenceSnapshot(client *ethclient.Client, epoch uint32, stakerId uint32) (*big.Int, error) {
	...
	if rf, ok := ret.Get(0).(func(*ethclient.Client, uint32, uint32) (*big.Int, error)); ok {
		return rf(client, epoch, stakerId)
	}
...
func (_m *VoteManagerUtils) GetSaltFromBlockchain(client *ethclient.Client) ([32]byte, error) {
	...
	var r0 [32]byte
	var r1 error
	if rf, ok := ret.Get(0).(func(*ethclient.Client) ([32]byte, error)); ok {
		return rf(client)
	}
...
func NewVoteManagerUtils(t interface {
	mock.TestingT
	Cleanup(func())
}) *VoteManagerUtils {
