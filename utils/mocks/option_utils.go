...
// Atoi provides a mock function with given fields: _a0
func (_m *OptionUtils) Atoi(_a0 string) (int, error) {
	ret := _m.Called(_a0)
...
// NewScanner provides a mock function with given fields: _a0
func (_m *OptionUtils) NewScanner(_a0 *os.File) *bufio.Scanner {
	ret := _m.Called(_a0)

	var r0 *bufio.Scanner
	if rf, ok := ret.Get(0).(func(*os.File) *bufio.Scanner); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *OptionUtils) TransactionReceipt(_a0 *ethclient.Client, _a1 context.Context, _a2 common.Hash) (*coretypes.Receipt, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *coretypes.Receipt
	if rf, ok := ret.Get(0).(func(*ethclient.Client, context.Context, common.Hash) *coretypes.Receipt); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
