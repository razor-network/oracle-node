...
func (_m *FileUtils) SaveDataToCommitJsonFile(filePath string, epoch uint32, commitData types.CommitData) error {
...
type mockConstructorTestingTNewFileUtils interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFileUtils(t mockConstructorTestingTNewFileUtils) *FileUtils {
	mock := &FileUtils{}
	mock.Mock.Test(t)
