...
type AccountInterface interface {
	CreateAccount(string, string, AccountInterface) accounts.Account
	getPrivateKeyFromKeystore(string, string, AccountInterface) *ecdsa.PrivateKey
	GetPrivateKey(string, string, string, AccountInterface) *ecdsa.PrivateKey
...
func (accountUtils AccountUtils) CreateAccount(path string, password string, accountUtil AccountInterface) accounts.Account {
	return CreateAccount(path, password, accountUtil)
}

func (accountUtils AccountUtils) getPrivateKeyFromKeystore(keystorePath string, password string, accountUtil AccountInterface) *ecdsa.PrivateKey {
	return getPrivateKeyFromKeystore(keystorePath, password, accountUtil)
}

func (accountUtils AccountUtils) GetPrivateKey(address string, password string, keystorePath string, accountUtil AccountInterface) *ecdsa.PrivateKey {
	return GetPrivateKey(address, password, keystorePath, accountUtil)
}
